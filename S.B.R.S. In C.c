...
#include <stdlib.h>
#include <string.h>
char ch[10][130]={"Nairobi to Kisii","Nairobi to Mombasa","Kisii to Nakuru","Kisumu to Mombasa","Kisii to Nairobi","Nakuru to Eldoret"};
char name[32][100]={'\0'};
char number[49][2]={'\0'};
int num1[49]={0};
int trno;
...
for(i=0; i<booking; i++)
{
    printf("Enter the details for ticket no %d=\n\n\n",i+1);
      ...
      scanf("%d",&number);
      printf("tEnter the name of person:--->");
...
fclose(b);
printf("\n\n");
printf("Your ksh1500 has been Returned\t\t\t\n");
   }
    ...
    do
{
	...
	i=0;
		...
		if(strcmp(uname,"Alex")==0 && strcmp(pword,"db638ee1")==0)
	{
	printf("\nLOGIN IS SUCCESSFUL");
